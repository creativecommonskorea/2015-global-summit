...
if (!empty( IMP_STORE_ID ) && !empty( IMP_API_KEY ) && !empty( IMP_API_SECRET )) {
  ...
  if ( $result->success ) {
      ...
      $mail_content .= '<span style="font-size:12px;color:#a0a0a0"> *참가 신청 내용 변경 및 취소는 10월 12일 월요일까지인 점 유의해주세요!</span><br/>';
      $mail_content .= '</div>';
      ...
      $mail_content .= '<a href="https://docs.google.com/forms/d/1TbYcyjGhpwpyDKQQJQIu-bqDQDTW0ACyqR8vUelW1yA/viewform?usp=send_form" target="_blank" style="color:#ef513c;">* 참가 신청 / 취소 / 변경은 10월 12일 월요일까지 받습니다. 이 점 유의해주세요!</a><br/>';
      $mail_content .= '</div>';
      $mail_content .= '</div>';
